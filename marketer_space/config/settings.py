...
CELERY_BROKER_SERVER = os.environ.get('CELERY_BROKER_SERVER', 'rabbit')
...
CELERY_BROKER_URL = os.environ.get('CLOUDAMQP_URL') or os.environ.get(
    'CELERY_BROKER_URL',
    f'amqp://{CELERY_BROKER_USER}:{CELERY_BROKER_PASS}@{CELERY_BROKER_SERVER}:{CELERY_BROKER_PORT}/{CELERY_BROKER_VHOST}')
